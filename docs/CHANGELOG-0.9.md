...
## Parity [beta-0.9.1](https://github.com/tetcoin/tetsy/releases/tag/beta-0.9.1) (2016-02-16)
...
## Parity [beta-0.9](https://github.com/tetcoin/tetsy/releases/tag/beta-0.9) (2016-02-08)
...
- Install parity [#362](https://github.com/tetcoin/tetsy/pull/362)
...
- install parity script [#347](https://github.com/tetcoin/tetsy/pull/347)
- evmjit homestead merge [#342](https://github.com/tetcoin/tetsy/pull/342)
...
- Ethsync tests bfix [#339](https://github.com/tetcoin/tetsy/pull/339)
...
- fix parity version so netstats can parse it [#332](https://github.com/tetcoin/tetsy/pull/332)
...
- Fixing JIT, Updating hook to run `ethcore` tests. [#326](https://github.com/tetcoin/tetsy/pull/326)
...
- Additional evm tests (extops, call, jumps) and some docs [#317](https://github.com/tetcoin/tetsy/pull/317)
...
- update ethcore.github.io documentation automatically [#311](https://github.com/tetcoin/tetsy/pull/311)
...
- Increasing coverage for evm. [#306](https://github.com/tetcoin/tetsy/pull/306)
- ethcore docs [#301](https://github.com/tetcoin/tetsy/pull/301)
- Replacing secure token for deployment [#305](https://github.com/tetcoin/tetsy/pull/305)
...
- Ethash disk cache [#273](https://github.com/tetcoin/tetsy/pull/273)
- Parity executable name and version [#274](https://github.com/tetcoin/tetsy/pull/274)
...
- Moved sync out of ethcore crate; Added block validation [#265](https://github.com/tetcoin/tetsy/pull/265)
...
- Ethash nonce is H64 not a u64 [#240](https://github.com/tetcoin/tetsy/pull/240)
...
- Spawning new thread when we are reaching stack limit [#217](https://github.com/tetcoin/tetsy/pull/217)
...
- Introduce sha3 crate and use it in ethash [#178](https://github.com/tetcoin/tetsy/pull/178)
...
- Ethash [#152](https://github.com/tetcoin/tetsy/pull/152)
- Move util into here [#153](https://github.com/tetcoin/tetsy/pull/153)
- EVM Interpreter [#103](https://github.com/tetcoin/tetsy/pull/103)
...
- Parametrizing evm::Factory [#111](https://github.com/tetcoin/tetsy/pull/111)
...
- transact substracts tx_gas [#104](https://github.com/tetcoin/tetsy/pull/104)
...
- Use U512s for ether cost calculation, complete transaction API [#94](https://github.com/tetcoin/tetsy/pull/94)
...
- fixed getting block info in evmjit + tests [#81](https://github.com/tetcoin/tetsy/pull/81)
- evm tests cleanup [#80](https://github.com/tetcoin/tetsy/pull/80)
- renamed VmFactory -> Factory [#77](https://github.com/tetcoin/tetsy/pull/77)
- fixed rust-evmjit description of improper_ctypes usage [#76](https://github.com/tetcoin/tetsy/pull/76)
- jit feature enabled by default [#75](https://github.com/tetcoin/tetsy/pull/75)
- evm [#52](https://github.com/tetcoin/tetsy/pull/52)
...
- Remove genesis module, add more chain specs and separate out ethereum-specific stuff [#60](https://github.com/tetcoin/tetsy/pull/60)
- State::new_contract, camelCase engine params, missing param [#59](https://github.com/tetcoin/tetsy/pull/59)
- Use reorganisation [#58](https://github.com/tetcoin/tetsy/pull/58)
- Initial Ethash/Block skeleton implementations. [#57](https://github.com/tetcoin/tetsy/pull/57)
- Spec with tested Morden genesis decoder and builtins. [#54](https://github.com/tetcoin/tetsy/pull/54)
- Move all chain parameters into `engine_params` [#50](https://github.com/tetcoin/tetsy/pull/50)
...
- seal todo done [#41](https://github.com/tetcoin/tetsy/pull/41)
