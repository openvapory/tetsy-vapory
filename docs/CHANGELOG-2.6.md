## Tetsy-Vapory [v2.6.8](https://github.com/openvapory/tetsy-vapory/releases/tag/v2.6.8)
...
Tetsy Vapory v2.6.3-stable is a patch release that improves security, stability and performance.
...
Tetsy Vapory v2.6.2-stable is a bugfix release that fixes a potential DoS attack in the trace_call RPC method. This is a critical upgrade for anyone running Parity nodes with RPC exposed to the public internet (and highly recommended for anyone else). For details see this blog post.
...
## Tetsy-Vapory [v2.6.0](https://github.com/openvapory/tetsy-vapory/releases/tag/v2.6.0)
...
* ethcore does not use byteorder ([#10829](https://github.com/openvapory/tetsy-vapory/pull/10829))
...
* removed EthEngine alias ([#10805](https://github.com/openvapory/tetsy-vapory/pull/10805))
* ethcore-bloom-journal updated to 2018 ([#10804](https://github.com/openvapory/tetsy-vapory/pull/10804))
* Fix a few typos and unused warnings. ([#10803](https://github.com/openvapory/tetsy-vapory/pull/10803))
* updated price-info to edition 2018 ([#10801](https://github.com/openvapory/tetsy-vapory/pull/10801))
* updated parity-local-store to edition 2018 ([#10800](https://github.com/openvapory/tetsy-vapory/pull/10800))
* updated project to ansi_term 0.11 ([#10799](https://github.com/openvapory/tetsy-vapory/pull/10799))
* ethcore-light uses bincode 1.1 ([#10798](https://github.com/openvapory/tetsy-vapory/pull/10798))
* ethcore-network-devp2p uses igd 0.9 ([#10797](https://github.com/openvapory/tetsy-vapory/pull/10797))
...
* Removed machine abstraction from ethcore ([#10791](https://github.com/openvapory/tetsy-vapory/pull/10791))
* Removed redundant ethcore-service error type ([#10788](https://github.com/openvapory/tetsy-vapory/pull/10788))
* Cleanup unused vm dependencies ([#10787](https://github.com/openvapory/tetsy-vapory/pull/10787))
* ethkey no longer uses byteorder ([#10786](https://github.com/openvapory/tetsy-vapory/pull/10786))
...
* refactor: Fix indentation in ethjson ([#10740](https://github.com/openvapory/tetsy-vapory/pull/10740))
...
* add_sync_notifier in EthPubSubClient holds on to a Client for too long ([#10689](https://github.com/openvapory/tetsy-vapory/pull/10689))
...
* Upgrade ethereum types ([#10670](https://github.com/openvapory/tetsy-vapory/pull/10670))
...
* docs: evmbin - Update Rust docs ([#10658](https://github.com/openvapory/tetsy-vapory/pull/10658))
* refactor: Related #9459 - evmbin: replace untyped json! macro with fully typed serde serialization using Rust structs ([#10657](https://github.com/openvapory/tetsy-vapory/pull/10657))
* docs: Add PR template ([#10654](https://github.com/openvapory/tetsy-vapory/pull/10654))
* docs: Add ProgPoW Rust docs to ethash module ([#10653](https://github.com/openvapory/tetsy-vapory/pull/10653))
...
* Upgrade to parity-crypto 0.4 ([#10650](https://github.com/openvapory/tetsy-vapory/pull/10650))
...
* [ethcore] remove error_chain ([#10616](https://github.com/openvapory/tetsy-vapory/pull/10616))
* Remove unused import ([#10615](https://github.com/openvapory/tetsy-vapory/pull/10615))
* Adds parity_getRawBlockByNumber, parity_submitRawBlock ([#10609](https://github.com/openvapory/tetsy-vapory/pull/10609))
...
* evm: add some mulmod benches ([#10600](https://github.com/openvapory/tetsy-vapory/pull/10600))
...
* fix(whisper): change expiry `unix_time + ttl + work` ([#10587](https://github.com/openvapory/tetsy-vapory/pull/10587))
* fix(evmbin): make benches compile again ([#10586](https://github.com/openvapory/tetsy-vapory/pull/10586))
...
* ethcore: improve timestamp handling ([#10574](https://github.com/openvapory/tetsy-vapory/pull/10574))
...
* Add filtering capability to `parity_pendingTransactions` (issue 8269) ([#10506](https://github.com/openvapory/tetsy-vapory/pull/10506))
* Remove calls to heapsize ([#10432](https://github.com/openvapory/tetsy-vapory/pull/10432))
* RPC: Implements eth_subscribe("syncing") ([#10311](https://github.com/openvapory/tetsy-vapory/pull/10311))
