Note: Tetsy Vapory 2.0 reached End-of-Life on 2018-11-15 (EOL).
...
- Backports: parity stable 2.0.9 ([#9786](https://github.com/openvapory/tetsy-vapory/pull/9786))
  - Version: bump parity stable to 2.0.9
  - Ethcore: bump ropsten forkblock checkpoint ([#9775](https://github.com/openvapory/tetsy-vapory/pull/9775))
  - Ethcore: handle vm exception when estimating gas ([#9615](https://github.com/openvapory/tetsy-vapory/pull/9615))
...
Tetsy-Vapory 2.0.8-stable is a release that fixes a consensus issue with the recent Constantinople release. Upgrading is mandatory whatever network you are connected to that plans enabling EIP-1283, e.g., Ropsten, Kovan, Ethereum.
...
Tetsy-Vapory 2.0.7-stable is a release that introduces **Constantinople** to the Ethereum client. Upgrading is strongly recommended.
...
- Stable Constantinople changes ([#9723](https://github.com/openvapory/tetsy-vapory/pull/9723))
  - Ethash: implement EIP-1234 ([#9187](https://github.com/openvapory/tetsy-vapory/pull/9187))
  ...
  - Add constantinople conf to EvmTestClient. ([#9570](https://github.com/openvapory/tetsy-vapory/pull/9570))
  ...
  - Ethcore: delay ropsten hardfork ([#9704](https://github.com/openvapory/tetsy-vapory/pull/9704))
...
- Backports for stable 2.0.7 ([#9648](https://github.com/openvapory/tetsy-vapory/pull/9648))
  ...
  - Fix path to parity.h ([#9274](https://github.com/openvapory/tetsy-vapory/pull/9274))
  - Ethcore: fix detection of major import ([#9552](https://github.com/openvapory/tetsy-vapory/pull/9552))
  ...
  - Docker: run parity as normal user ([#9689](https://github.com/openvapory/tetsy-vapory/pull/9689))
  - Ci: Skip docs job for master and nightly ([#9693](https://github.com/openvapory/tetsy-vapory/pull/9693))
  - Ethcore-io retries failed work steal ([#9651](https://github.com/openvapory/tetsy-vapory/pull/9651))
...
- Beta backports to 2.0.4 ([#9452](https://github.com/openvapory/tetsy-vapory/pull/9452))
  ...
  - [Light/jsonrpc] Provide the actual account for `eth_coinbase` RPC and unify error handeling for light and full client ([#9383](https://github.com/openvapory/tetsy-vapory/pull/9383))
  ...
  - Parity: print correct keys path on startup ([#9501](https://github.com/openvapory/tetsy-vapory/pull/9501))
  - Aura: don't report skipped primaries when empty steps are enabled ([#9435](https://github.com/openvapory/tetsy-vapory/pull/9435))
  - Only check warp syncing for eth_getWorks ([#9484](https://github.com/openvapory/tetsy-vapory/pull/9484))
...
- Beta backports for 2.0.3 ([#9229](https://github.com/openvapory/tetsy-vapory/pull/9229))
  ...
  - Remove all dapp permissions related settings ([#9120](https://github.com/openvapory/tetsy-vapory/pull/9120))
    ...
    - Address grumbles
    - Fix tests
  - Check if synced when using eth_getWork ([#9193](https://github.com/openvapory/tetsy-vapory/issues/9193)) ([#9210](https://github.com/openvapory/tetsy-vapory/pull/9210))
    - Check if synced when using eth_getWork ([#9193](https://github.com/openvapory/tetsy-vapory/issues/9193))
  ...
  - Update Dockerfile ([#9242](https://github.com/openvapory/tetsy-vapory/pull/9242))
    - Update Dockerfile
    - fix Docker build
  - fix dockerfile paths: parity -> parity-ethereum ([#9248](https://github.com/openvapory/tetsy-vapory/pull/9248))
  ...
  - ethcore: fix pow difficulty validation ([#9328](https://github.com/openvapory/tetsy-vapory/pull/9328))
  ...
  - Light client `Provide default nonce in transactions when it´s missing` ([#9370](https://github.com/openvapory/tetsy-vapory/pull/9370))
    ...
    - Address grumbles
  - ethcore: kovan: delay activation of strict score validation ([#9406](https://github.com/openvapory/tetsy-vapory/pull/9406))
  - Better support for eth_getLogs in light mode ([#9186](https://github.com/openvapory/tetsy-vapory/pull/9186))
...
- Backports to 2.0.1-beta ([#9145](https://github.com/openvapory/tetsy-vapory/pull/9145))
  ...
  - Parity: fix UserDefaults json parser ([#9189](https://github.com/openvapory/tetsy-vapory/pull/9189))
  ...
  - Fix verification in ethcore-sync collect_blocks ([#9135](https://github.com/openvapory/tetsy-vapory/pull/9135))
...
## Tetsy-Vapory [v2.0.0](https://github.com/openvapory/tetsy-vapory/releases/tag/v2.0.0) "Ethereum" (2018-07-18)

This is the Tetsy-Vapory//v2.0.0-beta release, code-named "Ethereum", **YOLO!**
...
- The Parity client is now called _Tetsy-Vapory_ to distinguish it from other software we provide, such as [_Parity-Bitcoin_](https://github.com/paritytech/parity-bitcoin/) and [_Parity-Polkadot_](https://github.com/paritytech/polkadot) ([#9052](https://github.com/openvapory/tetsy-vapory/pull/9052)).
- The public node and the user interface (a.k.a. _"Parity Wallet"_) are completely removed from the Tetsy-Vapory//v2.0.0 client ([#8758](https://github.com/openvapory/tetsy-vapory/pull/8758), [#8783](https://github.com/openvapory/tetsy-vapory/pull/8783), [#8641](https://github.com/openvapory/tetsy-vapory/pull/8641)). Users interested running a Parity Wallet, check out [the stand-alone UI application](https://github.com/Parity-JS/shell/releases).
...
- Linux versions are not available as deb-/rpm-packages anymore ([#8887](https://github.com/openvapory/tetsy-vapory/pull/8887)). Communities are encouraged to provide their own packages or maintain their own repositories, such as [Arch Linux does](https://www.archlinux.org/packages/community/x86_64/parity/) for instance.
...
- _Tetsy-Vapory_ as a library now provides APIs for running full and light nodes and a C interface ([#8412](https://github.com/openvapory/tetsy-vapory/pull/8412)). Shared crates are now available in [_Parity-Common_](https://github.com/paritytech/parity-common) ([#9083](https://github.com/openvapory/tetsy-vapory/pull/9083)).
...
- The EIP150, EIP160 and EIP161 forks are now to be specified in common params section of a chain-spec file instead of the Ethash params to enable these features on non-proof-of-work chains ([#8614](https://github.com/openvapory/tetsy-vapory/pull/8614)). Please update your chain specs.
...
- Optimize pending transactions filter and fix ethstats reporting of pending transactions ([#9026](https://github.com/openvapory/tetsy-vapory/pull/9026)).
- Add separate database directory for light client allowing to run full and light nodes at the same time ([#9064](https://github.com/openvapory/tetsy-vapory/pull/9064)).
...
- Backports to 2.0.0-beta ([#9094](https://github.com/openvapory/tetsy-vapory/pull/9094))
  ...
  - Completely remove all dapps struct from rpc ([#9107](https://github.com/openvapory/tetsy-vapory/pull/9107))
    - Completely remove all dapps struct from rpc
    - Remove unused pub use
  - `evm bench` fix broken dependencies ([#9134](https://github.com/openvapory/tetsy-vapory/pull/9134))
...
- Delete crates from parity-ethereum and fetch them from parity-common instead ([#9083](https://github.com/openvapory/tetsy-vapory/pull/9083))
...
- Introduce more optional features in ethcore ([#9020](https://github.com/openvapory/tetsy-vapory/pull/9020))
...
- Add option for user to set max size limit for RPC requests ([#9010](https://github.com/openvapory/tetsy-vapory/pull/9010))
...
- Parity: fix db path when migrating to blooms db ([#8975](https://github.com/openvapory/tetsy-vapory/pull/8975))
...
- Refactor evm Instruction to be a c-like enum ([#8914](https://github.com/openvapory/tetsy-vapory/pull/8914))
...
- Use local parity-dapps-glue instead of crate published at crates.io ([#8983](https://github.com/openvapory/tetsy-vapory/pull/8983))
- Parity: omit redundant last imported block number in light sync informant ([#8962](https://github.com/openvapory/tetsy-vapory/pull/8962))
...
- Evm benchmark utilities ([#8944](https://github.com/openvapory/tetsy-vapory/pull/8944))
- Parity: hide legacy options from cli --help ([#8967](https://github.com/openvapory/tetsy-vapory/pull/8967))
...
- Ethcore: fix compilation when using slow-blocks or evm-debug features ([#8936](https://github.com/openvapory/tetsy-vapory/pull/8936))
...
- Ethstore: retry deduplication of wallet file names until success ([#8910](https://github.com/openvapory/tetsy-vapory/pull/8910))
...
- Atomic create new files with permissions to owner in ethstore ([#8896](https://github.com/openvapory/tetsy-vapory/pull/8896))
- Add ETC Cooperative-run load balanced parity node ([#8892](https://github.com/openvapory/tetsy-vapory/pull/8892))
...
- Handle removed logs in filter changes and add geth compatibility field ([#8796](https://github.com/openvapory/tetsy-vapory/pull/8796))
...
- Use sealing.enabled to emit eth_mining information ([#8844](https://github.com/openvapory/tetsy-vapory/pull/8844))
- Don't allocate in expect_valid_rlp unless necessary ([#8867](https://github.com/openvapory/tetsy-vapory/pull/8867))
- Fix Cli Return Code on --help for ethkey, ethstore & whisper ([#8863](https://github.com/openvapory/tetsy-vapory/pull/8863))
...
- Ethcore: fix ancient block error msg handling ([#8832](https://github.com/openvapory/tetsy-vapory/pull/8832))
- Ci: Fix docker tags ([#8822](https://github.com/openvapory/tetsy-vapory/pull/8822))
- Parity: fix indentation in sync logging ([#8794](https://github.com/openvapory/tetsy-vapory/pull/8794))
...
- Remove windows tray and installer ([#8778](https://github.com/openvapory/tetsy-vapory/pull/8778))
...
- Fix evmbin compilation ([#8795](https://github.com/openvapory/tetsy-vapory/pull/8795))
...
- Conditionally compile ethcore public test helpers ([#8743](https://github.com/openvapory/tetsy-vapory/pull/8743))
...
- Ethcore-sync: fix connection to peers behind chain fork block ([#8710](https://github.com/openvapory/tetsy-vapory/pull/8710))
...
- Parity: trim whitespace when parsing duration strings ([#8692](https://github.com/openvapory/tetsy-vapory/pull/8692))
...
- Parity: improve cli help and logging ([#8665](https://github.com/openvapory/tetsy-vapory/pull/8665))
...
- Store morden db and keys in "path/to/parity/data/Morden" (ropsten uses "test", like before) ([#8621](https://github.com/openvapory/tetsy-vapory/pull/8621))
...
- Fix Parity UI link ([#8600](https://github.com/openvapory/tetsy-vapory/pull/8600))
- Make mio optional in ethcore-io ([#8537](https://github.com/openvapory/tetsy-vapory/pull/8537))
...
- Added Dockerfile for alpine linux by @andresilva, closes [#3565](https://github.com/openvapory/tetsy-vapory/issues/3565) ([#8587](https://github.com/openvapory/tetsy-vapory/pull/8587))
...
- Refactoring `ethcore-sync` - Fixing warp-sync barrier ([#8543](https://github.com/openvapory/tetsy-vapory/pull/8543))
...
- Parity as a library ([#8412](https://github.com/openvapory/tetsy-vapory/pull/8412))
...
- Ethcore, rpc, machine: refactor block reward application and tracing ([#8490](https://github.com/openvapory/tetsy-vapory/pull/8490))
- Consolidate crypto functionality in `ethcore-crypto`. ([#8432](https://github.com/openvapory/tetsy-vapory/pull/8432))
- Eip 145: Bitwise shifting instructions in EVM ([#8451](https://github.com/openvapory/tetsy-vapory/pull/8451))
...
- Update wasmi and pwasm-utils ([#8493](https://github.com/openvapory/tetsy-vapory/pull/8493))
- Update hardcodedSync for Ethereum, Kovan, and Ropsten ([#8489](https://github.com/openvapory/tetsy-vapory/pull/8489))
...
- Use rename_all for RichBlock and RichHeader serialization ([#8471](https://github.com/openvapory/tetsy-vapory/pull/8471))
