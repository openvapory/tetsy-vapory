Note: Tetsy Vapory 2.2 reached End-of-Life on 2019-02-25 (EOL).
...
## Tetsy-Vapory [v2.2.9](https://github.com/openvapory/tetsy-vapory/releases/tag/v2.2.9) (2019-02-03)
...
Tetsy-Vapory 2.2.7-stable is a consensus-relevant security release that reverts Constantinople on the Ethereum network. Upgrading is mandatory for Ethereum, and strongly recommended for other networks.
...
- Backports for stable 2.2.7 ([#10163](https://github.com/openvapory/tetsy-vapory/pull/10163))
  ...
  - Pull constantinople on ethereum network ([#10189](https://github.com/openvapory/tetsy-vapory/pull/10189))
...
Tetsy-Vapory 2.2.5-beta is an important release that introduces Constantinople fork at block 7080000 on Mainnet.
...
- Increase Gas-floor-target and Gas Cap ([#9564](https://github.com/openvapory/tetsy-vapory/pull/9564)): the default values for gas floor target are `8_000_000` and gas cap `10_000_000`, similar to Geth 1.8.15+.
...
- RPC: `parity_allTransactionHashes` ([#9745](https://github.com/openvapory/tetsy-vapory/pull/9745)): Get all pending transactions from the queue with the high performant `parity_allTransactionHashes` RPC method.
- Support `eth_chainId` RPC method ([#9783](https://github.com/openvapory/tetsy-vapory/pull/9783)): implements EIP-695 to get the chainID via RPC.
...
- Backport to parity 2.2.1 beta ([#9905](https://github.com/openvapory/tetsy-vapory/pull/9905))
  - Bump version to 2.2.1
  - Fix: Intermittent failing CI due to addr in use ([#9885](https://github.com/openvapory/tetsy-vapory/pull/9885))
  - Fix Parity not closing on Ctrl-C ([#9886](https://github.com/openvapory/tetsy-vapory/pull/9886))
...
- Backports to parity beta 2.2.0 ([#9820](https://github.com/openvapory/tetsy-vapory/pull/9820))
...
- Rpc: parity_allTransactionHashes ([#9745](https://github.com/openvapory/tetsy-vapory/pull/9745))
...
- Fix(light-rpc/parity) : Remove unused client ([#9802](https://github.com/openvapory/tetsy-vapory/pull/9802))
...
- Support eth_chainId RPC method ([#9783](https://github.com/openvapory/tetsy-vapory/pull/9783))
- Ethcore: bump ropsten forkblock checkpoint ([#9775](https://github.com/openvapory/tetsy-vapory/pull/9775))
- Docs: changelogs for 2.0.8 and 2.1.3 ([#9758](https://github.com/openvapory/tetsy-vapory/pull/9758))
...
- Update a few parity-common dependencies ([#9663](https://github.com/openvapory/tetsy-vapory/pull/9663))
...
- Ethcore: minor optimization of modexp by using LR exponentiation ([#9697](https://github.com/openvapory/tetsy-vapory/pull/9697))
...
- Docker: run as parity user ([#9689](https://github.com/openvapory/tetsy-vapory/pull/9689))
- Ethcore: mcip3 block reward contract ([#9605](https://github.com/openvapory/tetsy-vapory/pull/9605))
- Verify block syncing responses against requests ([#9670](https://github.com/openvapory/tetsy-vapory/pull/9670))
- Add a new RPC `parity_submitWorkDetail` similar `eth_submitWork` but return block hash ([#9404](https://github.com/openvapory/tetsy-vapory/pull/9404))
- Resumable EVM and heap-allocated callstack ([#9360](https://github.com/openvapory/tetsy-vapory/pull/9360))
- Update parity-wordlist library ([#9682](https://github.com/openvapory/tetsy-vapory/pull/9682))
...
- Ethereum libfuzzer integration small change ([#9547](https://github.com/openvapory/tetsy-vapory/pull/9547))
...
- Ethcore/VerificationQueue don't spawn up extra `worker-threads` when explictly specified not to ([#9620](https://github.com/openvapory/tetsy-vapory/pull/9620))
- Rpc: parity_getBlockReceipts ([#9527](https://github.com/openvapory/tetsy-vapory/pull/9527))
...
- Bump smallvec to 0.6 in ethcore-light, ethstore and whisper ([#9588](https://github.com/openvapory/tetsy-vapory/pull/9588))
...
- Simplify ethcore errors by removing BlockImportError ([#9593](https://github.com/openvapory/tetsy-vapory/pull/9593))
...
- Update ethabi-derive, serde, serde_json, serde_derive, syn && quote ([#9553](https://github.com/openvapory/tetsy-vapory/pull/9553))
...
- New ethabi ([#9511](https://github.com/openvapory/tetsy-vapory/pull/9511))
