...
- Revert "Transaction Queue integration" [#602](https://github.com/tetcoin/tetsy/pull/602)
...
- Use latest era instead of end era as journal marker [#414](https://github.com/tetcoin/tetsy/pull/414)
