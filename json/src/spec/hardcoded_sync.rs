...
mod tests {
	...
	use vapory_types::{U256, H256 as Vap256};
	...
	fn hardcoded_sync_deserialization() {
		...
		assert_eq!(deserialized, HardcodedSync {
			...
			chts: vec![
				H256(Vap256::from_str("11bbe8db4e347b4e8c937c1c8370e4b5ed33adb3db69cbdb7a38e1e50b1b82fa").unwrap()),
				H256(Vap256::from_str("d7f8974fb5ac78d9ac099b9ad5018bedc2ce0a72dad1827a1709da30580f0544").unwrap()),
			]
		});
	}
}
