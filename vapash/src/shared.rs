...
pub fn get_cache_size(block_number: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = CACHE_BYTES_INIT + CACHE_BYTES_GROWTH * (block_number / VAPASH_EPOCH_LENGTH);
...
pub fn get_data_size(block_number: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = DATASET_BYTES_INIT + DATASET_BYTES_GROWTH * (block_number / VAPASH_EPOCH_LENGTH);
	sz = sz - VAPASH_MIX_BYTES as u64;
	while !is_prime(sz / VAPASH_MIX_BYTES as u64) {
		sz = sz - 2 * VAPASH_MIX_BYTES as u64;
	}
	sz as usize
}
