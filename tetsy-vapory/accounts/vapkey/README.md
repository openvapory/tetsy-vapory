...
- `<phrase>` - Tetsy recovery phrase, 12 words

```
vapkey info --brain "this is sparta"
```
...
```
vapkey generate prefix --brain 00cf
```
...
- `<public>` - vapory public, 64 bytes long
...
```
RUST_LOG="info" vapkey recover "00cf3711cbd3a1512570639280758118ba0b2bcb" "thwarting scandal creamer nuzzle asparagus blast crouch trusting anytime elixir frenzied octag"
```

```
INFO:vapkey::brain_recover: Invalid word 'octag', looking for potential substitutions.
INFO:vapkey::brain_recover: Closest words: ["ocean", "octagon", "octane", "outage", "tag", "acting", "acts", "aorta", "cage", "chug"]
INFO:vapkey::brain_recover: Starting to test 7776 possible combinations.
