...
pub fn import_account(cmd: &ImportWallet, kp: tetsy_crypto::publickey::KeyPair, password: Password) {
	...
	let secret_store = Box::new(VapStore::open_with_iterations(dir, cmd.iterations).unwrap());
...
pub fn import_account(_cmd: &ImportWallet, _kp: tetsy_crypto::publickey::KeyPair, _password: Password) {}
