...
/// Tetsy tries to round block.gas_limit to multiple of this constant
...
// 2) it will be a nearest (with tendency to increase) multiple of TETSY_GAS_LIMIT_DETERMINANT
