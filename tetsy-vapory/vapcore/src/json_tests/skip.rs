...
//!
//! Looks in the `vapory/tests/test-issues/currents.json` file. This file contains two
...
use vapjson::test_helpers::skip::SkipTests;

lazy_static! {
	pub static ref SKIP_TESTS: SkipTests = {
		let skip_data = include_bytes!("../../res/vapory/tests-issues/currents.json");
