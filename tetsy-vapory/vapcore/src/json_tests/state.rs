...
pub fn json_chain_test<H: FnMut(&str, HookType)>(path: &Path, json_data: &[u8], start_stop_hook: &mut H) -> Vec<String> {
	...
	let tests = vapjson::test_helpers::state::Test::load(json_data)
	...
	for (name, test) in tests.into_iter() {
...

		{
			...
			for (spec_name, states) in test.post_states {
				...
				let spec = match VvmTestClient::fork_spec_from_json(&spec_name) {
					Some(spec) => spec,
					None => {
...
mod state_tests {
	...
	//      Issues:
	//          https://github.com/openvapory/tetsy-vapory/issues/11078
	//          https://github.com/openvapory/tetsy-vapory/issues/11079
	//          https://github.com/openvapory/tetsy-vapory/issues/11080
	...
	// Tx:
	// https://github.com/vaporyco/tests/blob/726b161ba8a739691006cc1ba080672bb50a9d49/GeneralStateTests/stZeroKnowledge2/ecmul_0-3_5616_28000_96.json#L170
	// Balance:
	// https://github.com/vaporyco/tests/blob/726b161ba8a739691006cc1ba080672bb50a9d49/GeneralStateTests/stZeroKnowledge2/ecmul_0-3_5616_28000_96.json#L126
