...
contract TxPermission {
    ...
    /// the specified gas price and data. Used by the Tetsy engine each time a transaction is about to be
    ...
    /// 0x01 - basic transaction (e.g. vapor transferring to user wallet);
    /// 0x02 - contract call;
