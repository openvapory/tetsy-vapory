...
//! ProgPoW (Programmatic Proof-of-Work) is the Vapory network's proposed new Application-Specific Integrated
...
//!
//! It would be a change from Vapory's current PoW mining algorithm known as Vapash.
//!
//! ProgPoW audits have been proposed to analyse the efficiency of a ProgPoW ASICs over
//! GPUs and analysis of the economic impact on the Vapory protocol.
//!
...
const PROGPOW_CNT_DAG: usize = VAPASH_ACCESSES;
const PROGPOW_DAG_LOADS: usize = 4;
const PROGPOW_MIX_BYTES: usize = 2 * VAPASH_MIX_BYTES;
