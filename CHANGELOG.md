...
Tetsy Vapory v2.7.2-stable is a patch version release of tetsy-vapory.
Starting in the 2.7.x series of releases, tetsy-vapory is switching to a single `stable` release
...
## Tetsy-Vapory [v2.7.1](https://github.com/openvapory/tetsy-vapory/releases/tag/v2.7.1)
Tetsy Vapory v2.7.1-stable is a patch version release of tetsy-vapory.
Starting in the 2.7.x series of releases, tetsy-vapory is switching to a single `stable` release
track. As a result, any clients that currently receive updates from the `beta`
track should switch to the `stable` track.
Due to database format changes, upgrading from 2.5.x or 2.6.x is one-way only.
...
Tetsy Vapory v2.7.0-stable is a minor version release of tetsy-vapory. As
of this release, tetsy-vapory is switching to a single `stable` release
track. As a result, any clients that currently receive updates from the `beta`
track should switch to the `stable` track.
...
* Add VaporCore support (#11402)
* json-tests: Fix compile error (#11384)
* vapcore/res: fix vapory classic chainspec blake2_f activation block num (#11391)
...
* vapcore/res: activate ecip-1061 on kotti and mordor (#11338)
...
* [vapcore]: apply filter when `PendingSet::AlwaysQueue` in `ready_transactions_filtered` (#11227)
* Update lib.rs (#11286)
* Don't prune ancient state when instantiating a Client (#11270)
* fixed verify_uncles error type (#11276)
* vapcore: fix rlp deprecation warnings (#11280)
* Upgrade tetsy-trie-db to 0.16.0. (#11274)
...
* Crypto primitives removed from vapkey (#11174)
...
* [vapash] chainspec validate `ecip1017EraRounds` non-zero (#11123)
...
* Refactor tetsy_listStorageKeys with count parameter optional (#11124)
* Make VIP712Domain Fields Optional (#11103)
...
* [vapash] remove manual unrolling  (#11069)
* vapcore/res: activate Istanbul on Ropsten, Görli, Rinkeby, Kovan (#11068)
* [sync]: rust 2018 (#11067)
* [vapcore]: move client test types to test-helpers (#11062)
* [sync]: remove unused dependencies or make dev (#11061)
* [vapcore]: reduce re-exports (#11059)
* [vvmbin] fix time formatting (#11060)
* Update hardcoded headers (foundation, classic, kovan,  xdai, ewc, ...) (#11053)
* cargo update -p vap-secp256k1 (#11052)
* vapcore: remove `test-helper feat` from build (#11047)
* Include test-helpers from vapjson (#11045)
* [vapcore]: cleanup dependencies (#11043)
* add more tx tests (#11038)
* Fix parallel transactions race-condition (#10995)
* [vapcore]: make it compile without `test-helpers` feature (#11036)
...
* Extract enjens to own crates (#10966)
...
* refactor: Refactor vvmbin CLI (#10742)
* journaldb changes (#10929)
* Allow default block parameter to be blockHash (#10932)
* Enable sealing when enjen is ready (#10938)
...
* additional arithmetic VVM opcode benchmarks (#10916)
...
* remove verify_transaction_unordered from enjen (#10891)
* Avast whitelist script (#10900)
* cleanup vapcore vapory module (#10899)
* Move more types out of vapcore (#10880)
* return block nonce when enjen is clique (#10892)
...
* whisper is no longer a part of tetsy-vapory repo (#10855)
* [vapash] remove mem::uninitialized (#10861)
* Docker images renaming (#10863)
* Move the substate module into vapcore/executive (#10867)
* Run cargo fix on a few of the worst offenders (#10854)
* removed redundant fork choice abstraction (#10849)
* Extract state-db from vapcore (#10858)
* Fix fork choice (#10837)
* Move more code into state-account (#10840)
* Remove compiler warning (#10865)
* [vapash] use static_assertions crate (#10860)
...
* refactor: Related #9459 - vvmbin: replace untyped json! macro with fully typed serde serialization using Rust structs (#10657)
* idiomatic changes to PodState (#10834)
* Allow --nat extip:your.host.here.org (#10830)
* When updating the client or when called from RPC, sleep should mean sleep (#10814)
* Remove excessive warning (#10831)
* Fix typo in README.md (#10828)
* vapcore does not use byteorder (#10829)
...
* Add filtering capability to `tetsy_pendingTransactions` (issue 8269) (#10506)
* removed VapEngine alias (#10805)
...
* vapcore-bloom-journal updated to 2018 (#10804)
* vapcore-light uses bincode 1.1 (#10798)
...
* vapcore-network-devp2p uses igd 0.9 (#10797)
* updated tetsy-local-store to edition 2018 and removed redundant Error type (#10800)
* Cleanup unused vm dependencies (#10787)
* Removed redundant vapcore-service error type (#10788)
* Removed machine abstraction from vapcore (#10791)
...
* vapcore/res: activate atlantis classic hf on block 8772000 (#10766)
...
* vapcore: enable ECIP-1054 for classic (#10731)
...
* docs: Add ProgPoW Rust docs to vapash module (#10653)
...
* Adds tetsy_getRawBlockByNumber, tetsy_submitRawBlock (#10609)
...
* [vapcore] remove error_chain (#10616)
* Remove unused import (#10615)
* vvm: add some mulmod benches (#10600)
...
* fix(vvmbin): make benches compile again (#10586)
...
* RPC: Implements vap_subscribe("syncing") (#10311)
