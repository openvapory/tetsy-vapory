...
//! Consensus tests for `PoA Clique Engine`, see http://eips.vapory.org/EIPS/eip-225 for more information

use std::sync::Arc;
use std::collections::HashMap;

use common_types::errors::{VapcoreError as Error, EngineError};
use vapcore::{
	block::*,
...
impl CliqueTester {
	...
	pub fn new_block_and_import(
...

		{
			...
			let sign = tetsy_crypto::publickey::sign(self.signers[&signer].secret(), &b.header.hash()).unwrap();
...
// Not part of http://eips.vapory.org/EIPS/eip-225
#[test]
