...
use tetsy_kvdb::PREFIX_LEN as DB_PREFIX_LEN;
use tetsy_rlp;
use tetsy_rlp_derive::{RlpEncodableWrapper, RlpDecodableWrapper, RlpEncodable, RlpDecodable};
...
impl tetsy_rlp::Encodable for BlockDetails {
...
impl tetsy_rlp::Decodable for BlockDetails {
