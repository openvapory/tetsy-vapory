...
/// Internal ids all functions runtime supports. This is just a glue for twasmi interpreter
...
pub mod signatures {
	use twasmi::{self, ValueType};
	use twasmi::ValueType::*;
	...
	impl Into<twasmi::Signature> for StaticSignature {
		fn into(self) -> twasmi::Signature {
			twasmi::Signature::new(self.0, self.1)
		}
	}
}
...
impl twasmi::ModuleImportResolver for ImportResolver {
