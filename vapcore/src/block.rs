...
impl LockedBlock {
	...
	/// TODO(https://github.com/openvapory/tetsy-vapory/issues/10407): This is currently only used in POW chain call paths, we should really merge it with seal() above.
	pub fn try_seal(
		self,
		engine: &dyn Engine,
		seal: Vec<Bytes>,
